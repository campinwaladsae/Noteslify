    ...
    <div>
      ...
      >
        <div className="sm:text-center">
          ...
          >
            See how Jotting customers around the globe are becoming productive
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
            <figure className="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p className="text-2xl font-medium dark:text-gray-400 text-gray-900">"With Jotting, I can organize all my notes and files in one place, and the search feature saves me time. I highly recommend Jotting to anyone looking for a privacy-friendly note-taking app."</p>
                </blockquote>
                <figcaption className="flex items-center justify-center mt-6 space-x-3">
                    <img className="w-6 h-6 rounded-full" src="https://cdn.Jotting.stonecss.com/cdn/assets/contacticon.jpeg" alt="profile"></img>
                    <div className="flex items-center divide-x-2 divide-gray-500">
                        <div className="pr-3 font-medium dark:text-gray-400 text-gray-900">Anonymous</div>
                        <div className="pl-3 text-sm font-light text-gray-500">Satisfied Jotting User</div>
                    </div>
                </figcaption>
            </figure>
        </div>
