    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          ...
          <h1 className="mb-4 text-4xl font-extrabold mt-4 md:text-4xl xl:text-5xl">Why choose Jotting?</h1>
          <p className="mb-6 font-medium text-gray-500 lg:mb-8 md:text-lg lg:text-2xl ">Make plans. Keep a journal. Clip anything from the web. Jotting lets you collect information quickly, organize it easily, and find it when you need it.</p>
        ...
        <section >
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                  <img className="rounded-lg" src="https://cdn.Jotting.stonecss.com/cdn/assets/opensourcelp.png" alt="mockup"></img>
              </div>  
        ...
        <section>
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className="mr-auto place-self-center lg:col-span-7">
                  ...
                  <p className="max-w-2xl mb-6 font-medium text-gray-500 lg:mb-8 md:text-lg lg:text-2xl ">Tired of not having the right info handy when you need it? Jotting automatically saves notes online and syncs them to all your devices.</p>
              </div>
              <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                  <img className="rounded-lg" src="https://cdn.Jotting.stonecss.com/cdn/assets/comingsoonlp.png" alt="mockup"></img>
              </div>                
          </div>
        </section>
        <section>
        ...
        <section>
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className="mr-auto place-self-center lg:col-span-7">
                  ...
                  <p className="max-w-2xl mb-6 font-medium text-gray-500 lg:mb-8 md:text-lg lg:text-2xl ">Many note-taking apps lack a fully functional web application. Jotting offers a complete lineup of features from any major browser.</p>
              </div>
              <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                  <img className="rounded-lg" src="https://cdn.Jotting.stonecss.com/cdn/assets/comingsoonlp.png" alt="mockup"></img>
              </div>                
